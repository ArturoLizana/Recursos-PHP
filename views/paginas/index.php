...
<section class="speakers">
    <h2 class="speakers__heading">Les conférenciers</h2>
    <p class="speakers__descripcion">Rencontrez nos experts DevWebCamp</p>
...
<section class="boletos">
    <h2 class="boletos__heading">Tickets & Prix</h2>
    <p class="boletos__descripcion">Tarifs pour DevWebCamp</p>

    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">En personne</p>
            <p class="boleto__precio">$199</p>
        </div>

        <div <?php aos_animacion(); ?> class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">Virtuel</p>
            <p class="boleto__precio">$49</p>
        </div>

        <div <?php aos_animacion(); ?> class="boleto boleto--gratis">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">Gratuit</p>
            <p class="boleto__precio">Gratuit - $0</p>
        </div>
    </div>
